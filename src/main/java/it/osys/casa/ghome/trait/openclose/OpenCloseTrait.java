...
public class OpenCloseTrait extends Trait {
	...
	private OpenCloseTraitWantListener openCloseTraitWantListener;
	...
	public OpenCloseTrait(Device device, boolean discreteOnlyOpenClose, boolean commandOnlyOpenClose, boolean queryOnlyOpenClose,
			Set<OpenCloseDirection> openDirections, OpenCloseTraitWantListener openCloseTraitWantListener) {
		...
		this.openCloseTraitWantListener = openCloseTraitWantListener;
	}
