...
public class ColorSettingTrait extends Trait {
	...
	private ColorSettingTraitWantListener colorSettingTraitWantListener;
	...
	public ColorSettingTrait(Device device, boolean commandOnlyColorSetting, Optional<ColorModelEnum> colorModel,
			Optional<ColorTemperatureRange> colorTemperatureRange, ColorSettingTraitWantListener colorSettingTraitWantListener) {
		...
		this.colorSettingTraitWantListener = colorSettingTraitWantListener;
	}
	...
	public void addAttributes(ObjectNode objectNode) {
		...
		colorTemperatureRange.ifPresent(ctr -> {
			ObjectNode octr = CasaGHomeSetup.getObjectMapper().createObjectNode();
	...
	public Map<String, Object> getStatus() {
		...
		colorModel.ifPresent(cm -> {
			switch (cm) {
			case hsv -> {
				ObjectNode spectrumHsv = CasaGHomeSetup.getObjectMapper().createObjectNode();
