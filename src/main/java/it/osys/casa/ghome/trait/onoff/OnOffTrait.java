...
public class OnOffTrait extends Trait {
	...
	private OnOffTraitWantListener onOffTraitWantListener;

	public OnOffTrait(Device device, boolean commandOnlyOnOff, boolean queryOnlyOnOff, OnOffTraitWantListener onOffTraitWantListener) {
		...
		this.onOffTraitWantListener = onOffTraitWantListener;
	}
	...
	public CompletableFuture<Void> executeCommand(String requestId, String command, JsonNode params) {
		...
		return onOffTraitWantListener.onWantOnOff(requestId, params.get("on").asBoolean());
	}
