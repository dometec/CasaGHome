...
import it.osys.casa.ghome.trait.brightness.BrightnessTraitWantListener;
...
import it.osys.casa.ghome.trait.colorsetting.ColorSettingTraitWantListener;
...
import it.osys.casa.ghome.trait.modes.ModesTraitWantListener;
...
public class Light extends Device {
	...
	public Light withOnOffTrait(boolean commandOnlyOnOff, boolean queryOnlyOnOff, OnOffTraitWantListener wantListener) {
		onOffTrait = new OnOffTrait(this, commandOnlyOnOff, queryOnlyOnOff, wantListener);
		addTraits(onOffTrait);
		return this;
	}

	public Light withBrightnessTrait(boolean commandOnlyBrightness, BrightnessTraitWantListener wantListener) {
		brightessTrait = new BrightnessTrait(this, commandOnlyBrightness, wantListener);
	...
	public Light withColorSettingTrait(boolean commandOnlyColorSetting, Optional<ColorModelEnum> colorModel,
			Optional<ColorTemperatureRange> colorTemperatureRange, ColorSettingTraitWantListener wantListener) {
		colorSettingTrait = new ColorSettingTrait(this, commandOnlyColorSetting, colorModel, colorTemperatureRange, wantListener);
	...
	public Light withModesTrait(boolean commandOnlyColorSetting, boolean queryOnlyOnOff, List<Mode> modes,
			ModesTraitWantListener wantListener) {
		modesTrait = new ModesTrait(this, commandOnlyColorSetting, queryOnlyOnOff, modes, wantListener);
